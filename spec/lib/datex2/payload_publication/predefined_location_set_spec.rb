describe 'lib/transporthacker/datex2/d2_logical_model/payload_publication/predefined_location_set.rb' do

  it "should allow a new object to be created" do
    expect(TransportHacker::Datex2::D2LogicalModel::PayloadPublication::PredefinedLocationSet.new()).to be_a TransportHacker::Datex2::D2LogicalModel::PayloadPublication::PredefinedLocationSet
  end
  ...
  it "should parse multiple predefinedLocation elements" do
    xml_fragment = '<predefinedLocationSet id="TestLocationSet"><predefinedLocation id="Test1"></predefinedLocation><predefinedLocation id="Test2"></predefinedLocation></predefinedLocationSet>'
    obj = TransportHacker::Datex2::D2LogicalModel::PayloadPublication::PredefinedLocationSet.new(xml_fragment)
    expect(obj.location_set).to be_a(Array)
